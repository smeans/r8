...
// !!!IDEA!!! allow a setting to specify preferred naming convention and show
// warnings when violated (e.g. TitleCase, camelCase, snake_case, kebab-case)
...
class R8TableTerm extends R8Term {
    ...
    get value() {
        // !!!TBD!!! needs table service implementation
        return undefined;
    }
...
class R8TableProvider extends R8Provider {
    constructor() {
        if (this.constructor == R8TableProvider) {
            throw new TypeError('abstract class R8TableProvider cannot be instantiated');
        }
    }
}
